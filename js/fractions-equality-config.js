 ...
 * please modify fractions-equality/package.json to control dependencies.
 *
 * RequireJS configuration file for the fractions-equality sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'fractions-equality-main' ],
  ...
  paths: {
    ...
    FRACTIONS_EQUALITY: '.',
    FRACTION_MATCHER: '../../fraction-matcher/js',
    JOIST: '../../joist/js',
    KITE: '../../kite/js',
